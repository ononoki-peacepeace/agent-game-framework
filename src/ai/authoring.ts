...
export function emptyWorld(profile:z.infer<typeof profileSchema>):WorldPackage { return {schema_version:1,framework_version:VERSION,meta:{id:'empty_world',title:'空白世界',description:''},enabled_modules:['core'],ruleset:{minutes_per_day:1440,max_wait_minutes:1440,talk_minutes:1,trade_minutes:1,default_check:'1d6',currencies:{},relationship_dimensions:{}},prompt_profile:profile,world:{description:''},entities:[{id:'player',type:'character',components:{identity:{name:'玩家',description:'',avatar_id:null}}}],events:[],player:{entity_id:'player'},gm_state:{notes:'',flags:{}},runtime:{time:{day:1,minute:0}}}; }
