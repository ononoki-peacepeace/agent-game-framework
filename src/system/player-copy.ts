 ...
 */
const moduleLabels: Record<string, string> = { map: '地图', characters: '人物', relationships: '关系', inventory: '背包', commerce: '商店', equipment: '装备', quests: '任务', routine: '生活模式', attributes: '属性', aptitudes: '资质', skills: '技能', traits: '特质', core: '核心' };
