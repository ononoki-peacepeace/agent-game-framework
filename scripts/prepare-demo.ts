...
const blueprint = worldInitializationSchema.extend({ locations: worldInitializationSchema.shape.locations.min(1) }).parse(JSON.parse(await readFile('content/worlds/town-blueprint.json', 'utf8')));
